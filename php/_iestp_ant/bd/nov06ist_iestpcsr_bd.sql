...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2020 a las 07:55:25
...
--
-- Base de datos: `nov06ist_iestpcsr_bd`
--
CREATE DATABASE IF NOT EXISTS `nov06ist_iestpcsr_bd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `actividad` (
  ...
  `IdElementoCapacidad` int(11) NOT NULL
...
CREATE TABLE `alumno` (
  `CodAlu` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,
  `w_usuario` char(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `f_reg` datetime DEFAULT current_timestamp(),
  `foto` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `condalu` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `idalumno` int(11) DEFAULT NULL,
  `idpadre` int(11) DEFAULT NULL,
  `idmadre` int(11) DEFAULT NULL,
  `anio` int(11) DEFAULT NULL,
  `conding` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nrocarnet` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'nro carnet control interno'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('03C025D', 'DBA', '2020-04-13 18:40:58', 'sdsddfassa', 'ACT', 16413, NULL, NULL, 2020, 'EXT', '2343-3433-3432-2342'),
('03ET086D', 'DBA', '2020-03-05 09:45:27', 'sdsddfassa', 'ACT', 16383, NULL, NULL, 2020, 'EXT', '2343-3433-3432-2342'),
('12QI469D', 'DBA', '2020-03-05 09:45:27', 'sdsddfassa', 'ACT', 16391, NULL, NULL, 2020, 'EXT', '2343-3433-3432-2342'),
('14CI006D', 'DBA', '2020-03-05 09:45:27', 'sdsddfassa', 'ACT', 16393, NULL, NULL, 2020, 'EXT', '2343-3433-3432-2342'),
('15CT388V', 'DBA', '2020-03-05 09:45:27', 'sdsddfassa', 'ACT', 16364, NULL, NULL, 2020, 'EXT', '2343-3433-3432-2342');
...
CREATE TABLE `ciclo` (
  ...
  `NomCiclo` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CodCiclo` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `clase_per` (
  `IdClase` int(11) NOT NULL,
  `CodClase` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DesClase` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Estado` tinyint(4) DEFAULT NULL,
  `freg` datetime DEFAULT current_timestamp() COMMENT 'current date',
  `wusuario` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'current user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'CLI', 'CLIENTE', 1, '2014-11-12 00:00:00', 'DBA'),
(2, 'ALU', 'ALUMNO', 1, '2014-11-12 00:00:00', 'DBA'),
(3, 'APO', 'APODERADO', 1, '2014-11-12 00:00:00', 'DBA'),
(4, 'TRA', 'TRABAJADOR', 1, '2014-11-12 00:00:00', 'DBA'),
(5, 'PRO', 'PROVEEDOR', 1, '2014-11-12 00:00:00', 'DBA'),
(6, 'POS', 'POSTULANTE', 1, '2014-11-12 00:00:00', 'DBA'),
(7, 'OTR', 'OTROS', 1, '2018-05-09 00:00:00', 'DBA');
...
CREATE TABLE `distrito` (
  ...
  `NomDistrito` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `distrito` (`IdDistrito`, `NomDistrito`, `IdProvincia`, `IdDpto`, `FReg`, `WUsuario`, `Codigo`) VALUES
(0, 'CHACHAPOYAS', 1, 1, '2006-07-10 00:00:00', 'DBA', 1),
(1, 'ASUNCION', 1, 1, '2006-07-10 00:00:00', 'DBA', 2),
(2, 'BALSAS', 1, 1, '2006-07-10 00:00:00', 'DBA', 3),
(3, 'CHETO', 1, 1, '2006-07-10 00:00:00', 'DBA', 4),
(4, 'CHILIQUIN', 1, 1, '2006-07-10 00:00:00', 'DBA', 5),
(5, 'CHUQUIBAMBA', 1, 1, '2006-07-10 00:00:00', 'DBA', 6),
(6, 'GRANADA', 1, 1, '2006-07-10 00:00:00', 'DBA', 7),
(7, 'HUANCAS', 1, 1, '2006-07-10 00:00:00', 'DBA', 8),
(8, 'LA JALCA', 1, 1, '2006-07-10 00:00:00', 'DBA', 9);
...
CREATE TABLE `dpto` (
  ...
  `nomdpto` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `freg` datetime NOT NULL,
  `wusuario` char(15) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `elementos_capacidad`
--

CREATE TABLE `elementos_capacidad` (
  `IdElementosCapacidad` int(11) NOT NULL,
  `Orden` int(11) NOT NULL,
...
CREATE TABLE `especialidad` (
  ...
  `NomEspecialidad` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ResolCrea` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `idsubarea` int(11) DEFAULT NULL,
  `fresolcrea` date DEFAULT NULL,
  `resolaut` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fresolaut` date DEFAULT NULL,
  `MencionTitulo` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mención del Titulo Profesional de la Especialidad',
  `ResolReva` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `matricula` (
  ...
  `w_usuario` char(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'current user',
  `CodAlu` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `IdEspecialidad` int(11) DEFAULT NULL,
  `estado` tinyint(4) DEFAULT NULL,
  `sistema` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `observa` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nrorecibo` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `H_Reg` time DEFAULT NULL COMMENT 'current time',
...
(42414, 1, 2, 2, 64, '2014-11-20 00:00:00', 'vhtapia', '03C025D', 8, 1, 'M', NULL, '000-0000000', '13:43:32', 1),
(42436, 2, 1, 4, 64, '2014-12-30 00:00:00', 'Ecalderon', '12QI469D', 3, 1, 'M', NULL, '006-23663', '11:58:28', 1),
(42441, 1, 1, 5, 66, '2015-03-17 00:00:00', 'YZumaeta', '14CI006D', 8, 1, 'M', NULL, '006-025173', '09:52:43', 1),
(42468, 1, 2, 3, 66, '2015-03-27 00:00:00', 'YZumaeta', '03ET086D', 2, 1, 'M', NULL, '006-025602', '11:07:16', 0),
(42484, 1, 2, 5, 66, '2015-04-06 00:00:00', 'YZumaeta', '15CT388V', 3, 1, 'M', NULL, '006-00706', '10:18:55', 1),
(42511, 1, 1, 3, 66, '2015-04-08 00:00:00', 'LChauca', '03C025D', 2, 1, 'M', NULL, '006-0026112', '11:07:08', 1),
(42538, 1, 1, 1, 66, '2015-04-13 00:00:00', 'YZumaeta', '12QI469D', 7, 1, 'M', NULL, '006-026284', '11:33:35', 1);
...
CREATE TABLE `matricula_rep` (
  ...
  `F_reg` date NOT NULL,
  `W_Usuario` char(15) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'current user',
  `nrorecibo` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Calificacion` int(11) DEFAULT NULL,
  `FReg_Cal` datetime DEFAULT NULL,
  `WUsuario_Cal` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `modulos` (
  ...
  `Observa` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `W_Usuario` char(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `F_Reg` date NOT NULL,
  `morden` int(11) DEFAULT NULL,
  `UndCompe` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Unidad de competencias',
...
CREATE TABLE `persona` (
  ...
  `TipoP` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `W_Usuario` char(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(current user)',
  `F_reg` datetime DEFAULT current_timestamp() COMMENT '(current date)',
...
(11668, '1', 'VHTAPIA', '2012-10-02 00:00:00', 1),
(11669, '1', 'VHTAPIA', '2012-10-02 00:00:00', 1),
(11670, '1', 'VHTAPIA', '2012-10-02 00:00:00', 1),
(12868, '1', 'VHTAPIA', '2014-12-02 00:00:00', 1),
(14252, '2', 'DGONZALES', '2016-06-13 00:00:00', 3),
(16328, '2', 'CCASTANEDA', '2019-05-08 00:00:00', 4),
(16335, '2', 'VHTAPIA', '2019-07-02 00:00:00', 4),
(16336, '2', 'CCASTANEDA', '2019-07-04 00:00:00', 4),
(16354, '2', 'CCASTANEDA', '2019-12-18 00:00:00', 4),
(16355, '2', 'CCASTANEDA', '2019-12-18 00:00:00', 4),
(16364, '2', 'DGONZALES', '2020-01-08 00:00:00', 2),
(16383, '2', 'DGONZALES', '2020-01-16 00:00:00', 2),
(16391, '2', 'DGONZALES', '2020-01-21 00:00:00', 2),
(16393, '2', 'DGONZALES', '2020-01-21 00:00:00', 2),
(16413, '2', 'DGONZALES', '2020-02-03 00:00:00', 2),
(16420, '2', 'DGONZALES', '2020-02-07 00:00:00', 1),
(16421, '2', 'DGONZALES', '2020-02-07 00:00:00', 1),
(16422, '2', 'DGONZALES', '2020-02-07 00:00:00', 1),
(16432, '2', 'DGONZALES', '2020-02-11 00:00:00', 1),
(16434, '2', 'DGONZALES', '2020-02-12 00:00:00', 1);
...
CREATE TABLE `planestudio_mod` (
  ...
  `Vigencia` char(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `planestudio_modvigencia`
--

CREATE TABLE `planestudio_modvigencia` (
  `IdVigencia` int(11) NOT NULL,
  `Vigencia` char(4) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `provincia` (
  ...
  `NomProvincia` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `iddpto` int(11) DEFAULT NULL,
  `freg` datetime DEFAULT NULL,
  `wusuario` char(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigo` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `p_juridica` (
  ...
  `RSocial` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Direccion` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Tele_Fijo1` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Ruc` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `idPersona` int(11) NOT NULL,
  `replegal` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `p_natural` (
  ...
  `IdDistrito` int(11) DEFAULT NULL,
  `APaterno` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `AMaterno` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Nombres` varchar(35) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Direccion` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Tele_fijo1` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Sexo` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `EstCivil` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NroDoc` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `IdPersona` int(11) NOT NULL,
  `Tele_Celu` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `f_nac` date DEFAULT NULL,
  `lugar_nac` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `titulo` char(7) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `p_natural` (`IdDocu`, `IdDistrito`, `APaterno`, `AMaterno`, `Nombres`, `Direccion`, `Tele_fijo1`, `Sexo`, `EstCivil`, `NroDoc`, `IdPersona`, `Tele_Celu`, `email`, `f_nac`, `lugar_nac`, `titulo`) VALUES
...
(NULL, NULL, 'URQUIAGA', 'RAMOS', 'ERIKA DEL ROCIO', NULL, NULL, 'F', NULL, NULL, 16413, NULL, 'cemp2703@gmail.com', NULL, NULL, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ra_capacidades`
--

CREATE TABLE `ra_capacidades` (
  `IdCapacidad` int(11) NOT NULL,
  `Descripcion` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Orden` int(11) NOT NULL,
  `FReg` datetime NOT NULL,
  `WUsuario` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ra_compempleabilidad`
--

CREATE TABLE `ra_compempleabilidad` (
  `IdCompEmpleabilidad` int(11) NOT NULL,
  `Orden` int(11) NOT NULL,
  `Descripcion` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `ra_docenteplan`
--

CREATE TABLE `ra_docenteplan` (
  `Id` int(11) NOT NULL,
  `IdTrabajador` int(11) NOT NULL,
  `IdSemestre` int(11) NOT NULL,
  `IdPlan` int(11) NOT NULL,
  `Estado` int(11) NOT NULL,
  `Observa` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `F_Reg` datetime NOT NULL,
  `W_Usuario` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdTurno` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `ra_indicadores`
--

CREATE TABLE `ra_indicadores` (
...
--
-- Estructura de tabla para la tabla `ra_indicador_tecevaluacion`
--

CREATE TABLE `ra_indicador_tecevaluacion` (
  `IdIndicador` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `ra_silabo`
--

CREATE TABLE `ra_silabo` (
  `IdSilabo` int(11) NOT NULL,
  `IdDocentePlan` int(11) NOT NULL,
  `IdCapacidad` int(11) NOT NULL,
  `Sumilla` int(11) NOT NULL,
  `RecursosDid` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Metodologia` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Fuentes` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Evaluacion` varchar(1500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Formula` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `FReg` datetime NOT NULL,
  `WUsuario` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `ra_silabo_compempleabilidad`
--

CREATE TABLE `ra_silabo_compempleabilidad` (
  `IdSilabo` int(11) NOT NULL,
  `IdCompEmpleabilidad` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `ra_tecevaluacion`
--

CREATE TABLE `ra_tecevaluacion` (
  `IdTecnica` int(11) NOT NULL,
  `Nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `NomCorto` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Estado` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `FReg` datetime NOT NULL,
  `WUsuario` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `regnotas_p` (
  ...
  `Observa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(42414, 636, 14, 2, '1', 'Ecalderon', '2014-11-14 00:00:00', '2013-12-27', '(03-11-2014)', NULL),
(42436, 377, 16, 1, '1', 'Ecalderon', '2014-11-20 00:00:00', '2011-12-30', '(24-10-2014)', NULL),
(42441, 792, 16, 1, '1', 'Ecalderon', '2014-11-20 00:00:00', '2013-01-04', '(25/07/2014)', NULL),
(42484, 9, 17, 1, '1', 'Ecalderon', '2014-12-10 00:00:00', '2011-12-30', '28/10/2014', NULL),
(42484, 10, 19, 1, '1', 'YZumaeta', '2014-12-23 00:00:00', '2013-12-27', '(22-12-2014)', NULL),
(42511, 11, 15, 1, '1', 'Ecalderon', '2014-12-26 00:00:00', '2014-12-30', NULL, NULL),
(42511, 44, 16, 1, '1', 'Ecalderon', '2014-12-26 00:00:00', '2014-12-30', NULL, NULL),
(42511, 47, 18, 1, '1', 'Ecalderon', '2014-12-26 00:00:00', '2014-12-30', NULL, NULL),
(42538, 48, 14, 1, '1', 'Ecalderon', '2014-12-26 00:00:00', '2014-12-30', NULL, NULL),
(42538, 54, 17, 1, '1', 'Ecalderon', '2014-12-26 00:00:00', '2014-12-30', NULL, NULL),
(42538, 55, 15, 1, '1', 'Ecalderon', '2014-12-26 00:00:00', '2014-12-30', NULL, NULL);
...
CREATE TABLE `regnotas_t` (
  ...
  `f_reg` datetime DEFAULT current_timestamp() COMMENT 'current date',
  `w_usuario` char(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CodAlu` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdModulo` int(11) NOT NULL,
  `Condicion` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 14, 13, 13, 13, '1', '2008-08-22', NULL, '2009-03-30 00:00:00', 'ECALDERON', '08CI373V', 1, 'T'),
(1, 13, 14, 13, 0, '1', '2008-08-22', NULL, '2008-10-24 00:00:00', 'ECALDERON', '08CI386N', 1, 'T'),
(1, 14, 13, 13, 14, '1', '2008-12-30', NULL, '2009-02-04 00:00:00', 'ECALDERON', '08CI387N', 1, 'T'),
(1, 13, 13, 13, 17, '1', '2008-12-30', NULL, '2009-02-04 00:00:00', 'ECALDERON', '08CI388N', 1, 'T'),
(1, 13, 13, 13, 15, '1', '2008-12-30', NULL, '2009-02-04 00:00:00', 'ECALDERON', '08CI390N', 1, 'T'),
(1, 13, 13, 13, 14, '1', '2008-12-30', NULL, '2009-02-04 00:00:00', 'ECALDERON', '08CI395N', 1, 'T'),
(1, 13, 13, 13, 0, '1', '2008-08-22', NULL, '2009-03-30 00:00:00', 'ECALDERON', '08CI398V', 1, 'T'),
(1, 13, 13, 13, 14, '1', '2008-08-22', NULL, '2009-03-30 00:00:00', 'ECALDERON', '08CI458V', 1, 'T'),
(2, 16, 15, 16, 15, '1', '2007-08-17', NULL, '2009-06-02 00:00:00', 'YZUMAETA', '07QI211D', 1, 'T'),
(2, 13, 14, 14, 16, '1', '2008-08-22', NULL, '2014-11-18 00:00:00', 'vhtapia', '08ET268D', 1, 'T'),
(2, 16, 13, 13, 16, '1', '2008-08-22', NULL, '2014-11-18 00:00:00', 'vhtapia', '08ET269D', 1, 'T'),
(2, 13, 13, 14, 16, '1', '2008-08-22', NULL, '2014-11-18 00:00:00', 'vhtapia', '08ET270D', 1, 'T'),
(2, 13, 14, 15, 15, '1', '2008-08-22', NULL, '2014-11-18 00:00:00', 'vhtapia', '08ET276D', 1, 'T'),
(2, 14, 13, 13, 16, '1', '2008-08-22', NULL, '2014-11-18 00:00:00', 'vhtapia', '08ET279D', 1, 'T'),
(2, 14, 13, 14, 14, '1', '2008-08-22', NULL, '2014-11-18 00:00:00', 'vhtapia', '08ET280D', 1, 'T');
...
CREATE TABLE `semestre` (
  ...
  `f_eval` date DEFAULT NULL,
  `estado` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `condicion` char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'T: Termino; V: VIgente',
  ...
  `vigencia` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(28, '1999 - II', 1999, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(29, '2000 - I', 2000, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(30, '2000 - II', 2000, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(31, '2001 - I', 2001, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(32, '2001 - II', 2001, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(33, '2002 - I', 2002, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(34, '2002 - II', 2002, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(35, '2003 - I', 2003, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(36, '2003 - II', 2003, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(37, '2004 - I', 2004, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(38, '2004 - II', 2004, '2005-01-01', '2005-01-01', '2005-01-01', '1', 'T', '2005-01-01', '2005-01-01', '1986', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(39, '2005 - I', 2005, '2005-01-01', '2005-08-19', '2005-08-19', '1', 'T', '2005-01-01', '2009-12-31', '2005', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(40, '2005 - II', 2005, '2005-08-20', '2006-01-06', '2006-01-06', '1', 'T', '2005-01-01', '2009-12-31', '2005', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(41, '2006 - I', 2006, '2006-01-01', '2006-07-31', '2006-01-18', '1', 'T', '2005-01-01', '2009-12-31', '2006', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(42, '2006 - II', 2006, '2006-08-01', '2007-12-31', '2006-12-29', '1', 'T', '2005-01-01', '2009-12-31', '2006', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(43, '2007 - I', 2007, '2007-01-01', '2007-07-31', '2007-08-17', '1', 'V', '2005-01-01', '2009-12-31', '2007', '2005-01-01', '2018-12-28 00:00:00', 'VHTAPIA'),
(44, '2007 - II', 2007, '2007-08-01', '2007-12-31', '2007-12-28', '1', 'V', '2005-01-01', '2009-12-31', '2007', '2005-01-01', '2018-12-28 00:00:00', 'VHTAPIA'),
(45, '2008-I', 2008, '2008-01-01', '2008-08-31', '2008-08-22', '1', 'T', '2005-01-01', '2009-12-31', '2009', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(46, '2008-II', 2008, '2008-09-01', '2008-12-31', '2008-12-30', '1', 'T', '2008-12-25', '2008-12-31', '2009', '2005-01-01', '2017-10-30 00:00:00', 'VHTAPIA'),
(47, '2009-0', 2009, '2009-01-01', '2009-03-31', '2009-03-31', '1', 'T', '2009-02-28', '2009-03-31', '2009', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(48, '2009-I', 2009, '2009-04-01', '2009-08-31', '2009-08-31', '1', 'V', '2009-04-30', '2010-03-31', '2009', '2005-01-01', '2019-11-26 00:00:00', 'VHTAPIA'),
(49, '2009-II', 2009, '2009-09-01', '2009-12-31', '2009-12-31', '1', 'V', '2009-09-30', '2010-04-30', '2009', '2016-10-01', '2019-11-26 00:00:00', 'VHTAPIA'),
(50, '2010-0', 2010, '2010-01-01', '2010-03-31', '2010-03-31', '1', 'T', '2010-02-28', '2011-04-30', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(51, '2010-I', 2010, '2010-04-01', '2010-08-13', '2010-08-13', '1', 'V', '2010-04-30', '2011-07-31', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(52, '2010-II', 2010, '2010-09-01', '2010-12-31', '2010-12-31', '1', 'V', '2011-09-30', '2011-07-31', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(53, '2011-0', 2011, '2011-01-01', '2011-03-27', '2011-03-31', '1', 'V', '2011-04-30', '2011-07-31', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(54, '2011-I', 2011, '2011-03-28', '2011-08-05', '2011-08-05', '1', 'V', '2011-08-30', '2011-11-15', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(55, '2011-II', 2011, '2011-08-06', '2011-12-30', '2011-12-30', '1', 'V', '2011-10-14', '2011-12-30', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(56, '2012-0', 2012, '2012-01-02', '2011-03-31', '2012-03-31', '1', 'V', '2011-03-30', '2011-03-30', '2010', '2005-01-01', '2014-11-13 00:00:00', 'DBA'),
(57, '2012-I', 2012, '2012-04-01', '2012-08-03', '2012-08-03', '1', 'V', '2012-04-15', '2013-09-02', '2010', '2013-07-17', '2014-11-13 00:00:00', 'DBA'),
(58, '2012-II', 2012, '2012-08-04', '2013-01-04', '2013-01-04', '1', 'V', '2012-09-28', '2013-09-02', '2010', '2013-07-17', '2014-11-13 00:00:00', 'DBA'),
(59, '2013-0', 2013, '2013-01-05', '2013-02-28', '2013-02-28', '1', 'V', NULL, NULL, '2010', '2013-02-28', '2014-11-13 00:00:00', 'DBA'),
(60, '2013-I', 2013, '2013-03-01', '2013-08-15', '2013-08-15', '1', 'V', '2013-04-30', '2013-10-17', '2010', '2013-06-17', '2014-11-13 00:00:00', 'DBA'),
(61, '2013-II', 2013, '2013-08-16', '2013-12-27', '2013-12-27', '1', 'V', '2013-10-11', '2013-12-20', '2010', '2014-01-30', '2014-11-13 00:00:00', 'DBA'),
(62, '2014-0', 2014, '2014-01-02', '2014-03-31', '2014-03-31', '1', 'V', NULL, NULL, '2010', '2014-01-30', '2014-11-13 00:00:00', 'DBA'),
(63, '2014-I', 2014, '2014-04-01', '2014-08-01', '2014-08-01', '1', 'V', '2014-06-23', '2014-07-31', '2010', NULL, '2014-11-13 00:00:00', 'DBA'),
(64, '2014-II', 2014, '2014-08-02', '2014-12-30', '2014-12-30', '1', 'V', '2014-09-30', '2014-12-30', '2010', '2014-12-26', '2014-12-23 00:00:00', 'VHTAPIA'),
(65, '2015-0', 2015, '2015-01-02', '2015-03-15', '2015-03-15', '1', 'V', NULL, NULL, '2010', NULL, '2014-11-13 00:00:00', 'DBA'),
(66, '2015-I', 2015, '2015-03-16', '2015-08-07', '2015-08-07', '1', 'V', '2015-06-08', '2015-07-23', '2010', NULL, '2015-07-23 00:00:00', 'JSALDANA'),
(67, '2015-II', 2015, '2015-08-08', '2015-12-30', '2015-12-30', '1', 'V', '2015-10-02', '2016-05-18', '2010', NULL, '2016-05-17 00:00:00', 'VHTAPIA'),
(68, '2016-0', 2016, '2016-01-02', '2016-02-29', '2016-02-29', '1', 'V', NULL, NULL, '2010', NULL, '2014-11-13 00:00:00', 'DBA'),
(69, '2016-I', 2016, '2016-03-01', '2018-12-30', '2016-07-27', '1', 'V', '2018-12-30', '2018-12-30', '2010', NULL, '2018-11-30 00:00:00', 'JSALDAÑA'),
(70, '2016-II', 2016, '2016-08-01', '2016-12-31', '2016-12-23', '1', 'V', '2016-09-09', '2016-12-30', '2010', NULL, '2016-11-23 00:00:00', 'VHTAPIA'),
(71, '2017-0', 2017, '2016-12-27', '2017-02-28', '2017-02-28', '1', 'V', NULL, NULL, '2010', NULL, '2016-12-14 00:00:00', 'DBA'),
(72, '2017-I', 2017, '2017-03-01', '2017-07-31', '2017-07-27', '1', 'V', '2017-05-31', '2017-08-04', '2010', '2017-06-16', '2018-07-18 00:00:00', 'VHTAPIA'),
(73, '2017-II', 2017, '2017-07-31', '2018-05-15', '2017-12-29', '1', 'V', '2017-10-31', '2017-11-05', '2010', '2017-12-21', '2018-05-15 00:00:00', 'JSALDANA'),
(74, '2018-0', 2018, '2018-01-02', '2018-02-28', '2018-02-28', '1', 'V', NULL, NULL, '2010', NULL, '2018-02-16 00:00:00', 'DBA'),
(75, '2018-I', 2018, '2018-03-19', '2018-07-31', '2018-07-31', '1', 'V', '2018-07-23', '2018-07-23', '2010', '2018-07-23', '2018-08-14 00:00:00', 'VHTAPIA'),
(76, '2018-II', 2018, '2018-08-13', '2018-12-31', '2018-12-28', '1', 'V', '2018-12-13', '2018-12-17', '2010', '2018-12-27', '2018-12-26 00:00:00', 'VHTAPIA'),
(77, '2019-0', 2019, '2019-01-02', '2019-02-28', NULL, '1', 'V', NULL, NULL, '2010', NULL, '2018-08-07 00:00:00', 'DBA'),
(83, '2019-I', 2019, '2019-03-01', '2019-07-31', '2019-07-26', '1', 'V', '2019-04-02', '2019-07-26', '2010', '2019-07-26', '2019-07-31 00:00:00', 'VHTAPIA'),
(84, '2019-II', 2019, '2019-08-01', '2019-12-31', '2019-12-20', '1', 'V', '2019-09-16', '2019-11-12', '2010', '2020-01-04', '2020-01-03 00:00:00', 'VHTAPIA'),
(85, '2020-0', 2020, '2020-01-01', '2020-03-15', NULL, '1', 'V', NULL, NULL, '2020', NULL, '2020-01-02 00:00:00', 'VHTAPIA'),
(86, '2020-I', 2020, '2020-03-16', '2020-07-31', NULL, '0', 'V', NULL, NULL, '2020', NULL, '2020-01-02 00:00:00', 'VHTAPIA'),
(87, '2020-II', 2020, '2020-08-01', '2020-12-31', NULL, '0', 'V', NULL, NULL, '2020', NULL, '2020-01-02 00:00:00', 'VHTAPIA');
...
CREATE TABLE `tipo_doc` (
  ...
  `NomDocu` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Modo` char(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Estado` tinyint(4) DEFAULT NULL,
  `freg` datetime DEFAULT current_timestamp() COMMENT 'current date',
  `wusuario` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'current user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipo_matricula` (
  ...
  `DesTipoMatri` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nomcorto` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `tipo_trab`
--

CREATE TABLE `tipo_trab` (
  `IdTipo` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `DesTipo` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trabajador` (
  `IdConTrab` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdSubArea` int(11) NOT NULL COMMENT 'Pertenece al Area',
  `F_Ingreso` date NOT NULL,
  `F_Cese` date NOT NULL,
  `f_reg` date NOT NULL,
  `w_usuario` char(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdTipo` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Foto` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdTrabajador` int(11) NOT NULL,
  `CodTrab` char(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Estado` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdCargo` int(11) NOT NULL,
  `login1` char(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autogenerado` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cupps` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `idafp` int(11) NOT NULL,
  `codmodular` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `IdProfesion` int(11) NOT NULL,
  `IdGradoAcad` int(11) NOT NULL,
  `NroResolucion` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `turno` (
  `IdTurno` int(11) NOT NULL,
  `DesTurno` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CodTurno` char(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `und_didactica` (
  `IdUnidad` int(11) NOT NULL,
  `Nombre` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Estado` int(11) DEFAULT NULL,
  `W_Usuario` char(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `F_Reg` date NOT NULL,
  `codigo` char(6) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `capacidad_und` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `und_didactica` (`IdUnidad`, `Nombre`, `Estado`, `W_Usuario`, `F_Reg`, `codigo`, `duracion`, `horas`, `Descripcion`, `capacidad_und`) VALUES
...
--
-- Indices de la tabla `clase_per`
--
ALTER TABLE `clase_per`
...
--
-- Indices de la tabla `elementos_capacidad`
--
ALTER TABLE `elementos_capacidad`
  ADD PRIMARY KEY (`IdElementosCapacidad`);
...
ALTER TABLE `matricula`
  ...
  ADD KEY `IdTipoMatri` (`IdTipoMatri`);

--
-- Indices de la tabla `matricula_rep`
--
ALTER TABLE `matricula_rep`
  ADD PRIMARY KEY (`IdEspecialidad`,`IdCiclo`,`IdTurno`,`IdSemestre`,`IdUnidad`,`CodAlu`) USING BTREE,
  ADD KEY `CodAlu` (`CodAlu`),
...
--
-- Indices de la tabla `planestudio_mod`
--
...
--
-- Indices de la tabla `p_juridica`
--
ALTER TABLE `p_juridica`
  ADD PRIMARY KEY (`idPersona`);

--
-- Indices de la tabla `p_natural`
--
ALTER TABLE `p_natural`
  ADD PRIMARY KEY (`IdPersona`),
  ADD KEY `IdDistrito` (`IdDistrito`),
  ADD KEY `IdDocu` (`IdDocu`) USING BTREE;

--
-- Indices de la tabla `ra_compempleabilidad`
--
ALTER TABLE `ra_compempleabilidad`
  ADD PRIMARY KEY (`IdCompEmpleabilidad`);

--
-- Indices de la tabla `ra_docenteplan`
--
ALTER TABLE `ra_docenteplan`
  ADD PRIMARY KEY (`Id`);

--
-- Indices de la tabla `ra_indicadores`
--
ALTER TABLE `ra_indicadores`
  ADD PRIMARY KEY (`IdIndicador`);

--
-- Indices de la tabla `ra_indicador_tecevaluacion`
--
ALTER TABLE `ra_indicador_tecevaluacion`
  ADD PRIMARY KEY (`IdIndicador`,`IdTecnica`);

--
-- Indices de la tabla `ra_silabo`
--
ALTER TABLE `ra_silabo`
  ADD PRIMARY KEY (`IdSilabo`);

--
-- Indices de la tabla `ra_silabo_compempleabilidad`
--
ALTER TABLE `ra_silabo_compempleabilidad`
  ADD PRIMARY KEY (`IdSilabo`,`IdCompEmpleabilidad`);

--
-- Indices de la tabla `ra_tecevaluacion`
--
ALTER TABLE `ra_tecevaluacion`
  ADD PRIMARY KEY (`IdTecnica`);

--
-- Indices de la tabla `regnotas_p`
--
ALTER TABLE `regnotas_p`
  ADD PRIMARY KEY (`IdMatricula`,`IdPlan`,`NroMatri`),
  ADD KEY `IdMatricula` (`IdMatricula`),
  ADD KEY `IdPlan` (`IdPlan`);

--
-- Indices de la tabla `regnotas_t`
--
ALTER TABLE `regnotas_t`
  ADD PRIMARY KEY (`NroMatri`,`CodAlu`,`IdModulo`),
  ADD KEY `IdModulo` (`IdModulo`);
...
ALTER TABLE `tipo_matricula`
  ADD PRIMARY KEY (`IdTipoMatri`);

--
-- Indices de la tabla `tipo_trab`
--
ALTER TABLE `tipo_trab`
...
--
-- Indices de la tabla `und_didactica`
--
ALTER TABLE `und_didactica`
...
ALTER TABLE `matricula`
  ...
  ADD CONSTRAINT `matricula_ibfk_7` FOREIGN KEY (`CodAlu`) REFERENCES `alumno` (`CodAlu`);
...
ALTER TABLE `matricula_rep`
  ...
  ADD CONSTRAINT `matricula_rep_ibfk_7` FOREIGN KEY (`CodAlu`) REFERENCES `alumno` (`CodAlu`);
...
--
ALTER TABLE `p_natural`
  ADD CONSTRAINT `p_natural_ibfk_1` FOREIGN KEY (`IdPersona`) REFERENCES `persona` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tipo_doc`
  ADD CONSTRAINT `tipo_doc_ibfk_1` FOREIGN KEY (`IdDocu`) REFERENCES `p_natural` (`IdDocu`);
COMMIT;
